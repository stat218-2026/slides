...
subtitle: "STAT 218 - Week 6, Lecture 4"
format: 
  revealjs:
      theme: simple
      slide-number: true
...
- Hypothesis testing is used for evaluating the strength of evidence against the null hypothesis.

- A parameter is a (fixed but typically unknown) number that describes a population. 

- Both confidence interval estimation and hypothesis testing are inferential procedures designed to draw conclusions about such population parameters based on sample data.
...
when water is used ($\mu_1$) is between 0.4 cm lower and 10.2 cm higher than the average when ancy is used.
:::
...
__Conclusion:__ We have moderate evidence against the null hypothesis. Our confidence interval includes 0.

That is, the data do not provide strong evidence that Ancymidol suppresses plant growth.
