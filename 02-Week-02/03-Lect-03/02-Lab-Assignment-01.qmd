...
Run the code chunk below. I will help you download the necessary packages.
...
**Question 0: Please add necessary `library()` functions (look at the Slide 10). If you skip this part, your functions will not work.**
